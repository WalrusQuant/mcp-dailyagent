  ...
  const actionButtons = (
    <>
      ...
      <button
        ...
        aria-label={isArchived ? `Unarchive ${habit.name}` : `Archive ${habit.name}`}
      >
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 md:gap-3 min-w-0">
        ...
        <div className="flex md:hidden items-center gap-0 shrink-0">{actionButtons}</div>
      </div>
        ...
        {weekDates.map((date) => {
          ...
          return (
            <button
              ...
              disabled={isArchived}
              className="flex-1 md:flex-none md:w-7 h-11 md:h-7 rounded-md flex items-center justify-center transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              style={{
      ...
      <div className="flex items-center gap-2 flex-1 min-w-0 justify-end">
        ...
        <div className="hidden md:group-hover:flex items-center gap-0 shrink-0">{actionButtons}</div>
      </div>
    </div>
  );
}
